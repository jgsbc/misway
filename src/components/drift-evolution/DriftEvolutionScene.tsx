...
import DriftEvolutionTrackGuidanceRig from "@/components/drift-evolution/DriftEvolutionTrackGuidanceRig";
...
function DriftEvolutionScene({
  ...
  return (
    <>
      ...
      />
      <DriftEvolutionTrackGuidanceRig vehicleStateRef={props.vehicleStateRef} />
