...
export const drift3dLandmarks: Drift3DLandmark[] = [
  ...
  // ─── Birth Yard ─────────────────────────────────────────────────────────
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — barque amarrée sur le canal
      {
        kind: "box",
        offset: [-6.2, 0.32, -2],
        args: [1.7, 0.2, 0.6],
  ...
  },
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — poubelles de ruelle et caisse renversée
      {
        kind: "cylinder",
        offset: [-3.5, 0.3, -3],
        args: [0.22, 0.24, 0.6],
  ...
  {
    // salle de sport derrière vitres : performance froide, cadence mécanique
    id: "birth-eux-gainent-glass-gym",
    origin: nodeOrigin("eux-gainent"),
    primitives: [
      {
        kind: "box",
        offset: [-2.8, 0, -4.2],
        ...
        solid: true,
        solidRadius: 1.7,
        pointLight: { color: "#dcecff", intensity: 1.15, distance: 7, y: 2.1 },
      },
      {
        kind: "box",
        offset: [-2.8, 2.35, -3.92],
        args: [5.5, 0.08, 0.12],
        color: "#f4f8ff",
        emissive: "#edf6ff",
        emissiveIntensity: 0.65,
        roughness: 0.35,
        pointLight: { color: "#edf6ff", intensity: 0.9, distance: 6, y: 2.35 },
      },
      {
        kind: "box",
        offset: [-2.8, 0, -3.35],
  ...
  // ─── Older Shadows ──────────────────────────────────────────────────────
  {
    ...
    primitives: [
      ...
      // cairn empilé (DRIFT-3D-20E : pierres qui montent)
      {
        kind: "sphere",
        offset: [-3.4, 0, -0.7],
        args: [0.22],
  ...
  },
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — jarres de terre cuite près d'un étal
      {
        kind: "cylinder",
        offset: [-4.7, 0.22, -0.2],
        args: [0.22, 0.16, 0.44],
      ...
      {
        kind: "sphere",
        offset: [-4.9, 0.14, 0.35],
        args: [0.15],
        color: "#b56b34",
        material: "plaster",
        roughness: 0.9,
      },
      // tissu coloré tendu entre deux perches (marché)
      {
        kind: "cylinder",
        offset: [-5.6, 0, -1.6],
        args: [0.04, 0.05, 1.8],
  ...
  },
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — boîte aux lettres qui déborde de courrier
      {
        kind: "cylinder",
        offset: [-1, 0, 0.6],
        args: [0.03, 0.04, 0.8],
      ...
      {
        kind: "box",
        offset: [-0.86, 0.7, 0.82],
        args: [0.15, 0.02, 0.2],
        color: "#e4ddcc",
        rotation: [0.9, -0.3, 0.1],
        roughness: 0.9,
      },
    ],
  },
  ...
  // ─── Vegetative Field ───────────────────────────────────────────────────
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — flamant rose gonflable de jardin (kitsch pavillonnaire)
      {
        kind: "sphere",
        offset: [1.6, 0.5, -1.9],
        args: [0.32],
  ...
  },
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — chouette perchée sur l'angle du toit
      {
        kind: "sphere",
        offset: [-1.95, 1.98, -1.95],
        args: [0.16],
        color: "#20242e",
        roughness: 0.9,
      },
  ...
  },
  {
    ...
    primitives: [
      ...
      // DRIFT-3D-20E — bouteille échouée et coquillages
      {
        kind: "cylinder",
        offset: [-2, 0.05, 2.2],
        args: [0.07, 0.07, 0.42],
  ...
  {
    // rituel lambda sur plage océanique : vagues hautes, sable, cercle simple
    id: "new-signal-eteeaooete-ocean-ritual",
    origin: nodeOrigin("eteeaooete"),
    primitives: [
      {
        kind: "box",
        offset: [-0.4, 0, 1.2],
      ...
      // lambda sculpté au sol : bois flotté et pierres, jamais néon
      {
        kind: "box",
        offset: [-0.58, 0.06, 0.75],
        args: [0.18, 0.1, 2.35],
        color: "#ffffff",
        material: "wood",
        textureRepeat: [1, 2],
      ...
      {
        kind: "sphere",
        offset: [2.1, 0.16, 0.82],
        args: [0.1],
        color: "#ffd991",
        emissive: "#f4b85d",
        emissiveIntensity: 0.38,
        pointLight: { color: "#f4b85d", intensity: 0.75, distance: 3.2, y: 0.28 },
      },
    ],
  },
  {
