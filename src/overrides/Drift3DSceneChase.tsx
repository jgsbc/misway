...
import OriginalDrift3DScene from "../components/drift-3d/Drift3DScene";
...
import { getDrift3DChaseCameraRig } from "./drift3dChase";
...
export default function Drift3DSceneChase(props: Drift3DSceneProps) {
  return (
    <>
