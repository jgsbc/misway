...
| `src/components/drift-3d/Drift3DScene.tsx` (EUX mount + WorldEdges mount hunks) | Modified by `92f4bfd`, `a15fba9`, `ad21600` | Independently evolved (terrain, vehicle physics, scatter) | Medium | Mixed: its WorldEdges-mount hunk belongs with `BASE-00`; its EUX-mount hunk belongs with the EUX GAINENT proof slice — must be split, not ported as one hunk | `DEFER_RUNTIME_TO_BY_EUX_20_30` (EUX mount) / `DEFER_RUNTIME_TO_BASE_00` (WorldEdges mount) | `DRIFT-IV-BY-EUX-20` and `DRIFT-IV-BASE-00` respectively |
